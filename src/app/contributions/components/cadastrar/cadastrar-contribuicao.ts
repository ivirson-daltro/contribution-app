...
@Component({
  selector: 'app-cadastrar-contribuicao',
  standalone: true,
  imports: [ReactiveFormsModule, MatDialogModule, MatIconModule, AsyncPipe],
  templateUrl: './cadastrar-contribuicao.html',
  styleUrl: './cadastrar-contribuicao.scss',
})
export class CadastrarContribuicaoComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<CadastrarContribuicaoComponent>,
  ) {}
